export function EyeOffIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M9.9 4.2A10.4 10.4 0 0112 4c5 0 9 4 10 8-.4 1.4-1.1 2.7-2 3.9M6.5 6.6C4.5 8 3 9.9 2 12c1 4 5 8 10 8 1.3 0 2.6-.2 3.7-.7M3 3l18 18M9.9 9.9a3 3 0 004.2 4.2" />
    </svg>
  );
}
...
export function ScaleIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M12 3v18M5 7h14M3 7l3 6a3 3 0 006 0l-3-6M15 7l3 6a3 3 0 006 0l-3-6" />
    </svg>
  );
}
...
export function PulseIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M20.8 8.6a5.5 5.5 0 00-9.3-3.9L11 5.2l-.5-.5A5.5 5.5 0 003.2 12l.9.9L11 20l6.9-7.1" />
...
export function LinkedInIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" {...props}>
      <path d="M4.98 3.5a2.5 2.5 0 11-.02 5 2.5 2.5 0 01.02-5zM3 9h4v12H3V9zm7 0h3.8v1.7h.05c.53-.95 1.83-1.95 3.77-1.95C21.6 8.75 23 11 23 14.4V21h-4v-5.9c0-1.6-.03-3.65-2.25-3.65-2.25 0-2.6 1.73-2.6 3.53V21h-4V9z" />
    </svg>
  );
}
